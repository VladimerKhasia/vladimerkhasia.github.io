    ...
    <section id="about" className="py-12 md:py-20 border-b border-gray-100">
      <div className="max-w-3xl">
        ...
        <div className="prose prose-lg text-gray-600 font-light leading-relaxed">
          ...
          <p className="mt-6">
              My goal is to build  <span className="text-academic-accent font-medium">adaptive frameworks that leverage efficient intelligence</span> to optimize performance across <span className="text-academic-accent font-medium">dynamic and complex environments</span>.
